...
//import io.github.constasj.gitea.api.RepositoryApi;
...
> repoDeletePullReviewRequests(body, owner, repo, index)
...
Long index = 789L; // Long | index of the pull request
try {
    apiInstance.repoDeletePullReviewRequests(body, owner, repo, index);
} catch (ApiException e) {
